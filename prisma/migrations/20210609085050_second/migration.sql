/*
  ...
  - Added the required column `updatedAt` to the `MenuSection` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "MenuSection" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
...
-- AlterTable
ALTER TABLE "Table" ADD COLUMN     "waiterId" INTEGER,
ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;

-- AddForeignKey
ALTER TABLE "Table" ADD FOREIGN KEY ("waiterId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
